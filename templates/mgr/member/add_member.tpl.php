                    ...
                    <form id="form" method="post" action="<?= URL('mgr/member2.saveMemberInfo','&id='.$info["id"])?>">
                        <div class="dis" name="f">
							...
							<div class="form-row"><label class="form-field">昵称</label>
                            	...
                            	<input name="realname" type="text" class="input-txt" id="realname" value="<?=isset($info["realname"]) && !empty($info["realname"]) ? $info["realname"] : '';?>" maxlength="150"  errormsg="昵称格式无效"/>
                            	</div>
                            </div>
                            <?php 
								if(empty($info)){
							...
							<?php }?>
                            <div class="form-row"><label class="form-field">学币</label>
                            <div class="form-cont" style="line-height:19px;">
                            <input name="frozen_money" type="text" class="input-txt" id="title" value="" datatype="n" maxlength="150" style="line-height:10px;" errormsg="检查填写信息"/>&nbsp;<font color="#666666">填写后将修改学币数</font>
                            </div>
                            </div>
							<div class="form-row">
