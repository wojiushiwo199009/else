...
<div class="footer">
    <div class="foot_con">
        ...
        <!--<div class="bottom"><p>公告京ICP备09096283&nbsp;&nbsp;Copyright©2014学啊版权所有</p></div>-->
        <div class="bottom"><?= $site_contact[0]["value"];?>技术支持：<a target="_blank" href="http://studio.hooos,com">虎窝工作室</a></div>
    </div>
</div>
<!--footer--end-->
</div>
