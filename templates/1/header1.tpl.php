...
<div class="top">
    <div class="top_con" style="position:relative;">   
        ...
        <div class="logo"><a href="/"><img src="<?= !empty($logo[0]['imgurl'])?$logo[0]['imgurl']:'/images/xuea_img_06.png'?>" style="width:180px"/></a></div>
...
<div class="tanchu">
   ...
   <form>
    <div class="zhuceAndDenglu" id='zhuceAndDenglu'>
        ...
        <div class="zhuce_left">
            <p><span class="xing">*</span><input type="text" name="usr" id="usr" class="phone" value="" placeholder="请输入手机号"/></p>
            <p><span class="xing">*</span><input type="password" name="pwd" id="pwd" class="pwd" placeholder="请输入密码"/></p>
            <p><span class="xing">*</span><input type="password" name="pwd1" id="pwd1" class="cfm_pwd" placeholder="请确认密码"/></p>
            <p><span class="xing">*</span><input type="text" name="nk_name" id="nk_name" class="nk_name" placeholder="请输入昵称"/></p>
...
<div class="denglu" id="alert">
    ...
    <div class="zhuce_left">
        ...
        <p><span class="xing">*</span><input type="text" name="username" id="username" class="phone" value="<?= $_COOKIE['xr_name']?>"  placeholder="请输入手机号"/></p>
...
<div class="zhmm_one" id="passw1">
    ...
    <div class="zhmm_left">
        <p><input type="text" name="" id="res_phone" class="phone" placeholder="请输入注册手机号"/></p>
